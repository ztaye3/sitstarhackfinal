...
class AddProductType extends Component {
    ...
    onAddProduct = () => {
        ...
        this.props.productAction(userInput, ADD_PRODUCT_TYPE, MANAGE_PRODUCT_TYPE_URL);
    }
...
export default connect(mapStateToProps, {productAction})(withTranslation()(withStyles(styles) (withRouter(AddProductType))));
