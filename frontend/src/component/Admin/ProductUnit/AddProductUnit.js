...
import {
    ADD_PRODUCT_TYPE,
    ADD_PRODUCT_UNIT,
    MANAGE_PRODUCT_TYPE_URL,
    MANAGE_PRODUCT_UNIT_URL
} from "../../../utils/Constant";
...
class AddProductUnit extends Component {
    ...
    onAddProduct = () => {
        ...
        this.props.productAction(userInput, ADD_PRODUCT_UNIT, MANAGE_PRODUCT_UNIT_URL);
    }
                      ...
                      <Grid className={classes.paper}>
                        ...
                        <form className={classes.form} noValidate>
                             ...
                             <TextField
                                ...
                                fullWidth
                                id="name"
                                label={t("admin.productUnit.productUnit")}
                                name="name"
                                autoComplete="name"
...
export default connect(mapStateToProps, {productAction}) (withTranslation()(withStyles(styles) (withRouter(AddProductUnit))));
