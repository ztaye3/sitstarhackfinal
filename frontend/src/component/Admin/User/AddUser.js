...
class AddUser extends Component {
    ...
    onAddUser = () => {
       if((this.state.re_password === this.state.password) && !isEmptyUtils(this.state.account_type)){
           ...
           const userInput = {
                                    is_customer : accountType === "is_customer" ,
                                    is_merchant : accountType === "is_merchant",
                        ...
                        <form className={classes.form} noValidate>
                            ...
                            <FormControl className={classes.formControl}>
                                                        ...
                                                        >
                                                          ...
                                                          <MenuItem className={classes.MenuItem} value={"is_merchant"}>{t("activate.merchant")}</MenuItem>
                                                          <MenuItem className={classes.MenuItem} value={"is_customer"}>{t("activate.customer")}</MenuItem>
                                                        </Select>
                              </FormControl>
