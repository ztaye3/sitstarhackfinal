                         ...
                         options={{
                          ...
                          columns={
                              [
                                ...
                                { title: t("admin.addUser.isMerchant"), field: 'is_merchant',
                                     type: "boolean",
                                    render: data => (data.is_merchant ? "True" : "False")},
                                { title: t("admin.addUser.isCustomer"), field: 'is_customer',
                                     type: "boolean",
                                    render: data => (data.is_customer ? "True" : "False")},
                                ...
                                { title: t("admin.addUser.isActivated"), field: 'is_activated',
                                  ...
                                  { title: t("admin.addUser.merchantCode"), field:  "user_merchant[0].identification",
